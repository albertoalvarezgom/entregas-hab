...
id int primary key auto_increment,
name enum
('NEW', 'CLASSIC', 'STANDARD') not null default 'STANDARD',
price int not null
);
...
return_date date,
constraint fk_member_rental foreign key
(id_member) references member
(id),
constraint fk_copy_rental foreign key
(id_copy) references copy
(id)
);
...
id_member int not null,
id_film int not null,
constraint fk_member_rating foreign key
(id_member) references member
(id),
constraint fk_film_rating foreign key
...
insert into actor
values(1, 'JOAQUIN', 'PHOENIX');
insert into actor
values(2, 'EMMA', 'WATSON');
insert into actor
values(3, 'AMY', 'ADAMS');
insert into actor
values(4, 'CHRISTIAN', 'BALE');
insert into actor
values(5, 'EMMA', 'STONE');
insert into actor
values(6, 'DANIEL', 'DAY-LEWIS');
insert into actor
values(7, 'LEONARDO', 'DI CAPRIO');
insert into actor
values(8, 'KATE', 'WINSLET');
...
values(2, 'ETHAN', 'COEN');
insert into director
values(3, 'PAUL THOMAS', 'ANDERSON');
insert into director
values(4, 'DAVID', 'LYNCH');
insert into director
values(5, 'ERIC', 'ROHMER');
...
values
    (1, 'UNIVERSAL', 'info@universal.com', 981121212);
insert into supplier
values
    (2, 'PARAMOUNT', 'info@paramount.com', 981222222);
...
insert into member
values
    (1, 'PAUL', 'SMITH', 'paul@smith.com', 98140440);
insert into member
values
    (2, 'LAURA', 'DERN', 'laura@dern.com', 981999999);

insert into rental
values
    (1, 1, 1, DATE_SUB(CURRENT_DATE(), INTERVAL
10 DAY), null);
insert into rental
values
    (2, 1, 10, DATE_SUB(CURRENT_DATE(), INTERVAL
7 DAY), DATE_SUB
(CURRENT_DATE
(), INTERVAL 2 DAY));
insert into rental
values
    (3, 2, 8, DATE_SUB(CURRENT_DATE(), INTERVAL
6 DAY), DATE_SUB
(CURRENT_DATE
(), INTERVAL 1 DAY));
insert into rental
values
    (4, 2, 3, DATE_SUB(CURRENT_DATE(), INTERVAL
2 DAY), null);
insert into rental
values
    (5, 1, 4, DATE_SUB(CURRENT_DATE(), INTERVAL
12 DAY),DATE_SUB
(CURRENT_DATE
(), INTERVAL 1 DAY));
insert into rental
values
    (6, 1, 6, DATE_SUB(CURRENT_DATE(), INTERVAL
2 DAY), null);
insert into rental
values
    (7, 2, 2, DATE_SUB(CURRENT_DATE(), INTERVAL
4 DAY), null);
insert into rental
values
    (8, 1, 8, DATE_SUB(CURRENT_DATE(), INTERVAL
12 DAY), DATE_SUB
(CURRENT_DATE
(), INTERVAL 7 DAY));
insert into rental
values
    (9, 2, 2, DATE_SUB(CURRENT_DATE(), INTERVAL
1 DAY), null);
insert into rental
values
    (10, 2, 7, DATE_SUB(CURRENT_DATE(), INTERVAL
9 DAY), DATE_SUB
(CURRENT_DATE
(), INTERVAL 4 DAY));
